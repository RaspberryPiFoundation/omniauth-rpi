...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Official OmniAuth strategy for Raspberry Pi.}
  spec.description   = %q{Official OmniAuth strategy for Raspberry Pi.}
  ...
  spec.add_dependency 'omniauth', '~> 1.4.0'
